...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Person__Modified__1273C1CD] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Person] ADD CONSTRAINT [PK__Person__543B4487629180F3] PRIMARY KEY CLUSTERED  ([person_ID]) ON [PRIMARY]
GO
