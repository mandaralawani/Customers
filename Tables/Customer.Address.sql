...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Address__Modifie__15502E78] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Address] ADD CONSTRAINT [PK__Address__091C2A1BEFD818EB] PRIMARY KEY CLUSTERED  ([AddressID]) ON [PRIMARY]
GO
